...
<body>
          ...
          <div class="col-md-12">
            ...
            <div class="home-top-section content-container">
              ...
              <div class="carousel">
                ...
                <div class="carousel-item"><img loading="lazy" src="https://res.cloudinary.com/wamp-infotech/image/upload/v1601479735/featured/new-featured-items-photo3.png" alt="MacBooks on Rent in Delhi, Gurgaon and Noida"><strong>Mac Books</strong></div>
  ...
  <script>
    $(document).ready(() => {
      ...
      if (screen.width < 640) {
        $("#waitForIt img").each((i, elem) => {
          let src = $(elem).attr("src");
          $(elem).attr("src", "php/image.php?src=../" + src + "&w=340&h=134");
        });
      }
      $("#waitForIt").removeClass("hide");
    });
  </script>
</body>
